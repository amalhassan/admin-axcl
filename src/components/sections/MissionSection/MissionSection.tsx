    ...
    <div className="flex flex-col justify-between text-center h-fit ">
      ...
      <div className='flex flex-col  gap-y-20 lg:gap-y-30 text-white mt-20 lg:mt-50 xl:mt-20'>
        <div className='flex flex-col gap-y-6'>
            ...
            <p className='z-1 font-family-sans font-medium text-2xl lg:text-4xl'>To Offer a Path Cultivating Industry Insiders</p>
            <p className='font-family-sans font-light italic text-2xl lg:text-3xl'>and Unlock the Launchpad to Dream Careers</p>
